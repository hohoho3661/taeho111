...
//bool Image::Init(const TCHAR * fileName, int _width, int _height, bool _isTrans, COLORREF _transColor)
//{
//	HDC hdc = GetDC(_hWnd);
//	hMemDC = CreateCompatibleDC(hdc);
//	hBit = (HBITMAP)LoadImage(_hInst, fileName, IMAGE_BITMAP, _width, _height, LR_LOADFROMFILE);
//	hOldBit = (HBITMAP)SelectObject(hMemDC, hBit);
//
//	width = _width;
//	height = _height;
//	isTrans = _isTrans;
//	transColer = _transColor;
//
//	ReleaseDC(_hWnd, hdc);
//}
//
//bool Image::Init(const TCHAR * fileName, int _width, int _height, int _maxFrameX, int _maxFrameY, bool _isTrans, COLORREF _transColor)
//{
//	HDC hdc = GetDC(_hWnd);
//	hMemDC = CreateCompatibleDC(hdc);
//	hBit = (HBITMAP)LoadImage(_hInst, fileName, IMAGE_BITMAP, _width, _height, LR_LOADFROMFILE);
...
//}
//
//void Image::Rander(HDC hdc, int destX, int destY)
//{
//	if (isTrans)
//	{
//		GdiTransparentBlt(
